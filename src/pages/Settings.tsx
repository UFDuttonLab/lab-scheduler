        ...
        {isLoading ? (
          ...
          <Card className="p-6 border-destructive/50">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-1">Data Management</h2>
                <p className="text-sm text-muted-foreground">
                  Danger zone: Clean up old data from the system
                </p>
              </div>
            </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will permanently delete all booking records from the database. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleClearAllBookings} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                    Delete All Bookings
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
