                ...
                {gameState === "menu" && (
                  <div className="flex flex-col items-center justify-center h-[600px] space-y-6">
                    <div className="text-center space-y-4">
                      ...
                      <h2 className="text-3xl font-bold">Welcome to Microbe Blaster!</h2>
                      <p className="text-muted-foreground max-w-md">
                        Click to blast multiplying microbes before they escape the petri dish.
            ...
            <div className="space-y-6">
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="text-sm text-muted-foreground mb-1">Eliminated</div>
                    <div className="text-2xl font-bold">{microbesEliminated}</div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-primary/5">
                ...
                <ul className="text-sm space-y-2 text-muted-foreground">
                  <li>🎯 Click microbes to eliminate them</li>
                  <li>💎 Golden microbes are worth 100 points!</li>
                  <li>⚡ Collect power-ups for special abilities</li>
                  <li>🔥 Build combos for score multipliers</li>
                  <li>❤️ Don't let microbes escape!</li>
                </ul>
              </Card>
            </div>
          </div>
